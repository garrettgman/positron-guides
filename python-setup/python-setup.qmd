...
* **Conda environments** - which are Python environments managed by the [conda package manager](https://docs.conda.io/projects/conda/en/latest/user-guide/getting-started.html). Conda stores these environments in a central place on your computer.
...
![Enviornments list](images/list.png){width=300}
